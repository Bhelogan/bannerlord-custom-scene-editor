...
```powershell
powershell -File build_asset_dump.ps1 -IncludeAllModules
```
...
```powershell
powershell -File build_asset_dump.ps1
powershell -File build_scene_catalog.ps1
powershell -File build_script_catalog.ps1
```
...
```powershell
powershell -File build_asset_dump.ps1 -GameDir "D:\Steam\steamapps\common\Mount & Blade II Bannerlord"
```
